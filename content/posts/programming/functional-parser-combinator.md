...
이전 글 [함수 컴포지션](/posts/programming/functional-composition/)과 [모나드로 배우는 함수형 에러 처리](/posts/programming/functional-monad-error-handling/)를 먼저 읽으면 더 자연스럽게 이어집니다.
...
*관련 글: [함수 컴포지션](/posts/programming/functional-composition/), [모나드로 배우는 함수형 에러 처리](/posts/programming/functional-monad-error-handling/), [계층형 설계](/posts/programming/functional-stratified-design/)*
