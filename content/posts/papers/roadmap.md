...
[강화학습 기반]                                         [World Model]
 DQN (2013)  ─────────────────────────────────────►  GAIA-1 (2023)
                                                              │
[3D 장면 표현]                                                ▼
 NeRF ──► 3DGS ──► 4D-GS ──► 3DGS-RT / 3DGUT ──► DrivingGaussian ──► HUGSIM
                               DIFIX3D+ / HUGS
```
...
3. [4D-GS](./4d-gaussian-splatting) — 동적 장면으로 확장
4. [3D Gaussian Ray Tracing](./3d-gaussian-ray-tracing) + [3DGUT](./3dgut-enabling-distorted-cameras-and-secondary-rays-in-gaussian-splatting) — 렌더링 품질 확장
5. [DrivingGaussian](./driving-gaussian-composite-gaussian-splatting) + [HUGS](./hugs-holistic-urban-3d-scene-understanding) — AV 적용
6. [HUGSIM](./hugsim-real-time-photorealistic-closed-loop-simulator) — 시뮬레이터 통합
