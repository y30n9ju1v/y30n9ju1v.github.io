...
[3D 장면 표현]                              [Neural Simulation]
 NeRF                                        LiDARsim (2020) — 실제 데이터 기반 LiDAR 시뮬 (UniSim 선행)
  ...
  └─► Mip-NeRF 360                           NeuRAD (2024) — 범용 AD NeRF
       └─► Instant-NGP                       HUGSIM (2024) — 3DGS 기반 실시간
            └─► 3DGS
                 ├─► [렌더링 품질]
...
2024  MagicDrive ──────────────────── 3D 기하 조건 기반 멀티카메라 스트리트뷰 생성 (ICLR)
      ...
      HUGS ────────────────────────── 외관·의미·모션 통합 3DGS, LiDAR 불필요
...
9. [GaussianWorld](https://y30n9ju1v.github.io/posts/papers/gaussianworld-gaussian-world-model-for-streaming-3d-occupancy-prediction) — 3DGS를 occupancy 예측에 연결, World Model 기반 스트리밍 시간 모델링
