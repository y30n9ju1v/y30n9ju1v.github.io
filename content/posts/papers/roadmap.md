...
8. [DrivingGaussian](./driving-gaussian-composite-gaussian-splatting) + [HUGS](./hugs-holistic-urban-3d-scene-understanding) — AV 적용
9. [UniSim](./unisim-neural-closed-loop-sensor-simulator) — NeRF 기반 멀티센서 시뮬레이터
10. [HUGSIM](./hugsim-real-time-photorealistic-closed-loop-simulator) — 시뮬레이터 통합
